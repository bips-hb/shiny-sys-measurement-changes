...
*"Assessing systematic measurement changes in single-wave study data: a simulation study"*.
...
## 🚀 Try the app
The interactive Shiny app is available online at: https://dataquality.qihs.uni-greifswald.de/vignettes.html#Methods.
